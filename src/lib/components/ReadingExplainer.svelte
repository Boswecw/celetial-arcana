...
<div class="card-surface p-8 rounded-2xl mt-8">
	<h3 class="text-2xl font-bold mb-6" style="color: #C6A7FF;">💬 Ask About Your Reading</h3>
		...
		<div class="flex gap-3">
			...
			{#if messages.length > 0 && messages[messages.length - 1].role === 'assistant'}
				<button
					...
					style="background-color: #FF4EDB; color: #EDEBFF; opacity: {isSpeaking
						? 0.7
						: 1}; cursor: pointer;"
				>
