<div
	class="min-h-screen flex flex-col items-center px-4 relative"
...
>
	...
	<div class="flex-1 flex items-center justify-center w-full z-10">
		<div class="max-w-4xl mx-auto text-center space-y-8 relative">
			...
			<!-- Description -->
			<div class="space-y-4 max-w-2xl mx-auto" style="color: #B3A9C7;">
				<p class="text-lg">
					Celestia Arcana combines ancient tarot wisdom with modern astrology to provide
					personalized readings aligned with celestial movements.
				</p>
				<p class="text-lg">
					Each card drawn is influenced by the positions of the stars and planets, creating a unique
					connection between the cosmos and your destiny.
				</p>
			</div>

			<!-- CTA Buttons -->
			<div class="flex flex-col sm:flex-row gap-4 justify-center pt-8">
				<a href="/deck" class="cta-primary"> Explore the Deck </a>
				<a href="/reading" class="cta-secondary"> Start a Reading </a>
				<a href="/alignment" class="cta-secondary"> View Your Chart </a>
				<a href="/admin/training" class="cta-secondary"> AI Dashboard </a>
			</div>
			...
			<div class="grid md:grid-cols-3 gap-6 pt-12">
				...
				<div class="card-surface p-8 space-y-4">
					...
					<h3
						class="text-2xl font-bold bg-gradient-to-r from-[#C6A7FF] to-[#7B61FF] bg-clip-text text-transparent"
					>
						78 Sacred Cards
					</h3>
				...
				<div class="card-surface p-8 space-y-4">
					<div class="text-4xl mb-2">🌙</div>
					<h3
						class="text-2xl font-bold bg-gradient-to-r from-[#FF4EDB] to-[#C6A7FF] bg-clip-text text-transparent"
					>
						Cosmic Alignment
					</h3>
					<p class="text-base leading-relaxed" style="color: #C6A7FF;">
				...
				<div class="card-surface p-8 space-y-4">
					<div class="text-4xl mb-2">🔮</div>
					<h3
						class="text-2xl font-bold bg-gradient-to-r from-[#4DF2B0] to-[#7B61FF] bg-clip-text text-transparent"
					>
						AI Insights
					</h3>
					<p class="text-base leading-relaxed" style="color: #C6A7FF;">
						Personalized interpretations powered by advanced AI analysis
					</p>
				</div>
			</div>

			<!-- Stats -->
			<div class="grid grid-cols-3 gap-8 pt-12 text-center w-full">
				<div>
					<p class="text-4xl font-bold" style="color: #7B61FF;">78</p>
					<p style="color: #B3A9C7;">Tarot Cards</p>
				</div>
				<div>
					<p class="text-4xl font-bold" style="color: #FF4EDB;">∞</p>
					<p style="color: #B3A9C7;">Possible Readings</p>
				</div>
				<div>
					<p class="text-4xl font-bold" style="color: #4DF2B0;">100%</p>
