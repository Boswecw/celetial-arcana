<script lang="ts">
	...
	onMount(async () => {
		try {
			const storedToken =
				typeof window !== 'undefined' ? window.localStorage.getItem('celestia_admin_token') : null;
			const adminToken =
				storedToken ||
...
<div
	...
	style="background: linear-gradient(135deg, #1a0033 0%, #2d0052 100%);"
>
	<div class="max-w-6xl mx-auto">
		...
		{:else if error}
			<div
				...
				style="background-color: rgba(255, 78, 219, 0.1); border: 2px solid #FF4EDB;"
			>
		...
		{:else if stats}
			...
			<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
				...
				<div
					class="p-8 rounded-lg"
					style="background: linear-gradient(135deg, rgba(123, 97, 255, 0.2), rgba(255, 78, 219, 0.1)); border: 2px solid #7B61FF;"
				>
				...
				<div
					class="p-8 rounded-lg"
					style="background: linear-gradient(135deg, rgba(77, 242, 176, 0.2), rgba(123, 97, 255, 0.1)); border: 2px solid #4DF2B0;"
				>
					<p class="text-sm font-semibold mb-2" style="color: #C6A7FF;">Average Rating</p>
					<p class="text-4xl font-bold" style="color: {getRatingColor(stats.averageRating)};">
				...
				<div
					class="p-8 rounded-lg"
					style="background: linear-gradient(135deg, rgba(255, 200, 87, 0.2), rgba(123, 97, 255, 0.1)); border: 2px solid #FFC857;"
				>
				...
				<div
					class="p-8 rounded-lg"
					style="background: linear-gradient(135deg, rgba(255, 78, 219, 0.2), rgba(123, 97, 255, 0.1)); border: 2px solid #FF4EDB;"
				>
				...
				<div
					class="p-8 rounded-lg"
					style="background: linear-gradient(135deg, rgba(77, 242, 176, 0.2), rgba(255, 78, 219, 0.1)); border: 2px solid #4DF2B0;"
				>
				...
				<div
					class="p-8 rounded-lg"
					style="background: linear-gradient(135deg, rgba(255, 200, 87, 0.2), rgba(77, 242, 176, 0.1)); border: 2px solid #FFC857;"
				>
			...
			{#if recommendations && recommendations.recommendations.length > 0}
				<div
					class="p-8 rounded-lg"
					style="background: linear-gradient(135deg, rgba(123, 97, 255, 0.15), rgba(255, 78, 219, 0.1)); border: 2px solid #7B61FF;"
				>
					<h2 class="text-2xl font-bold mb-6" style="color: #EDEBFF;">
			...
			<!-- Info Section -->
			<div
				class="mt-12 p-8 rounded-lg"
				style="background-color: rgba(123, 97, 255, 0.1); border: 2px solid #7B61FF;"
			>
				...
				<ul class="space-y-3" style="color: #EDEBFF;">
					...
					<li>
						✅ <strong>Pattern Recognition:</strong> System identifies successful card combinations and
						themes
					</li>
					<li>
						✅ <strong>Prompt Optimization:</strong> ChatGPT prompts are enhanced based on patterns
					</li>
